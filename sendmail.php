...
if(isset($_FILES['attachment']))
{
    ...
    $reply_to_email = "pankaj250483@gmail.com"; //sender email, it will be used in "reply-to" header
    $subject     = "Application Form"; //subject for the email
    $message     = "Application Form"; //body of the email
